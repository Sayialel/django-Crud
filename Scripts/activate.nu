...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\lenovo pc\PycharmProjects\djangoCrud_Proj\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\lenovo pc\PycharmProjects\djangoCrud_Proj\venv\Scripts\deactivate.nu'
